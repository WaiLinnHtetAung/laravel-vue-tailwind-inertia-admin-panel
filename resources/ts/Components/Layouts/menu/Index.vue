...
// import logoDark from '@/assets/images/user1.jpg'
// import logoLight from '@/assets/images/user1.jpg'
// import logoSm from '@/assets/images/user1.jpg'
import { menuItems } from "@/Components/Layouts/utils";
import SubMenu from "./SubMenu.vue";
import { useLayoutStore } from "../../../store/layout";
import { LucideNetwork } from "lucide-vue-next";
import { LAYOUTS, SIDEBAR_SIZE } from "@/Pages/const";
...
const path = computed(() => usePage().props.current_path);
        ...
        >
          <template v-for="menuItem in menuItemData" :key="menuItem.title">
            <li
              ...
              class="px-4 py-1 mt-3 text-vertical-menu-item group-data-[sidebar=dark]:text-vertical-menu-item-dark group-data-[sidebar=brand]:text-vertical-menu-item-brand group-data-[sidebar=modern]:text-vertical-menu-item-modern uppercase font-medium text-[11px] cursor-default tracking-wider group-data-[sidebar-size=sm]:hidden group-data-[layout=horizontal]:hidden inline-block group-data-[sidebar-size=md]:block group-data-[sidebar-size=md]:underline group-data-[sidebar-size=md]:text-center group-data-[sidebar=dark]:dark:text-zink-200"
            >
